...
<script>
		...
		kakao.maps.event.addListener(map, 'click', function(mouseEvent) {
			...
			//mouseEvent.latLng.set(127.120244, 37.5479482);
		    // 마우스로 클릭한 위치입니다 
		    //clickPosition = mouseEvent.latLng;
		    var clickPosition = new kakao.maps.LatLng(37.5475224, 127.1199882);
		   
	        console.log('da'+clickPosition);
		    //var test = JSON.stringify(clickPosition);
		    //console.log('teswt'+test);
		    
		    //var q = JSON.parse(test);
		    //console.log('q : ' + q);
		    console.log(clickPosition.Ga);
		    clickPosition.Ga = 127.1199873
		    clickPosition.Ha = 37.5475233
		    console.log(clickPosition.Ga);
		    
		    var test2 = JSON.stringify(clickPosition);
		    console.log('tt :' + test2);
		    //clickPosition += (37.5475233,127.1199873);
