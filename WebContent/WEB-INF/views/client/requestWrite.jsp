		...
		<form id="mailWrite" name="mail_id" method="post" action="requestWrite" onsubmit="return checkForm()">
		 <div class="form-group">
		   ...
		   <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="fromname" name="from_name" placeholder="보내는 이름을 입력하세요" value="${requestmail.to_name}">
		  	<span id="fromnameError" class="error" style="color:red">${fromnameError}</span>
		  </div>
		  <div class="form-group">
		    <label for="formGroupExampleInput2">보내는 사람 주소</label>
		    <input type="text" class="form-control" name="from_address" id="toname" placeholder="받는 사람이름을 입력하세요" value="${requestmail.from_name}">
		    <span id="fromaddressError" class="error" style="color:red">${fromaddressError}</span>
		  </div>
		 
		  <div class="form-group">
		    <label for="formGroupExampleInput2">받는 사람이름</label>
		    <input type="text" class="form-control" name="to_name" id="toaddress" placeholder="보내는 사람주소를 입력하세요" value="${requestmail.from_address}">
		    <span id="tonameError" class="error" style="color:red">${tonameError}</span>
		  </div>
		  <div class="form-group">
		    <label for="formGroupExampleInput2">받는 사람주소</label>
		    <input type="text" class="form-control" name="to_address" id="toaddress" placeholder="받는 사람주소 입력하세요" value="${requestmail.to_address}">
		    <span id="toaddressError" class="error" style="color:red">${toaddressError}</span>
		  </div>
		  <div class="form-group">
		    <label for="formGroupExampleInput2">마을 이름</label>
		    <input type="text" class="form-control" name="vid" id="villagename" value="${requestmail_villageList.get(0).vname }">
		    <span id="villagenameError" class="error" style="color:red">${villagenameError}</span>
		  </div>
		   <div class="form-group">
		    <label for="formGroupExampleInput">우편물 무게</label>
		    <input type="text" class="form-control" name="mail_weight" id="mailweight" placeholder="우편물 무게를 입력하세요" value="${requestmail.mail_weight}">
		  	<span id="mailweightError" class="error" style="color:red">${mailweightError}</span>
		  </div>
		  <div class="form-group">
		    <label for="formGroupExampleInput">배송 상태</label>
		    <input type="text" class="form-control" name="state_id" id="stateid" value="${requestmail.stateList.get(0).state_name }">
